...
var d = /** @class */ (function (_super) {
    ...
    d.prototype.renderList = function () {
        var _this = this;
        return (<react_native_1.View>
        <react_native_1.Text style={{ textAlign: 'center', marginTop: 20 }}>首页</react_native_1.Text>
        ...
        <react_native_1.View style={{ display: 'flex', justifyContent: "center", alignItems: 'center', marginTop: 20 }}>
          ...
          <react_native_1.Image style={{
            ...
            height: 100,
              ...
              <react_native_1.Button onPress={function () {
            console.log("点击图片");
            _this.props.navigation.push('NewsDetail');
        }} title="点击跳转新闻详情"/>
        </react_native_1.View>
